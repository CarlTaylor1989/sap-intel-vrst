            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-7 text">
                        <h2>Uncovering Insights and Opportunities<br/>Hidden in Big Data</h2>
                        <p><strong>10th October 2014 - 12:00 BST, 13:00 CEST</strong></p>
                        <p>
                    ...
                    <div class="col-sm-5">
                        <div class="speaker-img">
                            <img src="/content/img/Shailesh-Tekurkar.jpg" class="img-thumbnail img-responsive">
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    CtimerObj.startClock("hrs","mins","secs",12,"10/10/2014");
</script>
<?php
